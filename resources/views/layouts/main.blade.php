...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('ssets/vendors/font-awesome/css/all.min.css') }}a">
...
<header class="edica-header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.html"><img src="{{ asset('assets/js/loader.js') }}" alt="Edica"></a>
